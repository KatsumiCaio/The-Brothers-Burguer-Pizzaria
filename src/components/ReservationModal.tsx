...
import { X, Calendar, Users, Clock, Flame, ArrowRight } from 'lucide-react';
...
export const ReservationModal: React.FC<ReservationModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-[#1A1614] border border-white/10 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl p-6 relative space-y-5"
